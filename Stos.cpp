    ...
    public:
        ...
        void Granica(){
            ...
            if(liczbaPol>1){ 
                ...
                for (int number= 0; number <= rozmiar; number++) { // ustalenie granic planszy na ostatnich polach
                ...
                if( n == 2){
                    for(int num=0; num<liczbaWolnychPol; num++){    
                        ...
                        if( *WOLNE[num]->pole == ' '){
                            *WOLNE[num]->pole = c;
                            UstawNaNieodwiedzone();
                            if ( GameOver(c)){  // chcemy aby 1 ruch wygrywał
                                *WOLNE[num]->pole = g;
                     ...
                     for(int num=0; num<liczbaWolnychPol; num++){
                        ...
                        if( *WOLNE[num]->pole == ' '){
                            *WOLNE[num]->pole = c;
                            UstawNaNieodwiedzone();
                            if ( !GameOver(c)){ //  1 ruch nie moze wygrywac 
